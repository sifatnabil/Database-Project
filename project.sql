...
VALUES('Shahjalal Airport', 'Dhaka'),
('Shah Poran Airport', 'Sylhet'),
('Chennai International Airport','Chennai')

INSERT INTO Worker(Name, Age, Payment, Job, AirportId) 
VALUES('Sifat Nabil', 24, 50000.00, 'Airport Dispatcher', 1),
('Sajid Eimo', 24, 80000.00, 'Operation Crew Manager', 2),
('Dipta Das',26,60000.00,'Flight Attendent', 3)

INSERT INTO Ticket(OrderNumber,FlightCompany, SeatClass, Price, PassengerName, FlightNumber) 
VALUES(1, 'Nabil Airlines', 'Business', 5000.00, 'Sifat Nabil', 2),
(2, 'US Bangla', 'First Class', 6000.00, 'Sajid Eimo', 1),
(3, 'Bangladesh Biman', 'Economy',3000.00, 'Dipta Das', 3)
